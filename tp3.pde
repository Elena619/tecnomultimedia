...
void draw(){
     ...
     if(estado == 10){
     pant(10,1,"Reiniciar","");    // once pantalla, op 2 final malo eliminar un boton, centrarlo y que reinicie
    }
     if(estado == 11){
...
void mousePressed(){
 ...
 if(estado == 1){                      //pantalla inicio 1
    if(disBoton(180,500) < 50)
     estado = 0;
     else if(disBoton(480,500) < 50)
     estado = 2;
     
 }else if(estado == 0){                    //pantalla creditos 2
    if(disBoton(280,400) < 50)
    estado = 1;  
    
 } else if(estado == 2){                //pantalla 3
    if(disBoton(280,400) < 50)
    estado = 3; 
 ...
 } else if(estado == 4){              //pantalla 5 final 1
    if(disBoton(280,400) < 50)
    estado = 1; 
    
 } else if(estado == 5){             //pantalla 6
    if(disBoton(280,400) < 50)
    estado = 6;
 ...
 }else  if(estado == 7){             //pantalla 8 ciervo y rata
    if(disBoton(180,500) < 50)
    estado = 11;
    else if(disBoton(480,500) < 50)
    estado = 8;
    
 } else if(estado == 11){              //pantalla 12 final 2 ciervo
    if(disBoton(280,400) < 50)
    estado = 1; 
    
 } else if(estado == 8){               //pantalla 9  rata2opciones
    if(disBoton(180,500) < 50)
    estado = 9;
     else if(disBoton(480,500) < 50)
    estado = 10;
 } else if(estado == 9){              //pantalla 10 final 3 final bueno opcion 1
    if(disBoton(280,400) < 50)
    estado = 1; 
 } else if(estado == 10){              //pantalla 1 final 4 final malo opcion 2
    if(disBoton(280,400) < 50)
    estado = 1; 
}
